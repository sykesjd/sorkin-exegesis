...
That... doesn't seems like something you want from an executive assistant. Part of the job involves being able to do research on behalf of your charge to help them make decisions more effectively, so the idea that Donna can fall for disreputable data does not exactly add up.
